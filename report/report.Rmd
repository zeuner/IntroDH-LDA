...
led to a huge amount of individual web pages to be downloaded.
...
which allowed for straightforward extraction from their HTML pages.
...
(TODO: Here comes Isidor's latest improvements for the analysis, including
...
of analysis. For one text corpus, training an LDA model with 500 iterations
required up to 2,7 GiB of virtual memory when the corpora were preprocessed
...
corpus required up to 87 hours on a student laptop. Due to the high memory
usage, possibilities for parallel processing of multiple text corpora
were limited on commodity hardware.
